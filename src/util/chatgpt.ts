...
export function makePrompt(question: QuestionAttributes): string {
	switch (question.type) {
		case QuestionTypes.GENERAL:
			...
			- If you determine that the question is unrelated to any illness or health matter, you should ignore the above and write, "Sorry, I can't answer anything but health-related questions" as your response.
