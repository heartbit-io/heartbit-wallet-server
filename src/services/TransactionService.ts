import { TransactionInstance, TransactionAttributes } from "../models/TransactionModel";
import { Op } from 'sequelize';


class TransactionService {
    
    async createTransaction(transaction: TransactionAttributes): Promise<TransactionInstance> {
