...
const getDoctorAnsweredQuestions = {
	tags: ['Doctors'],
	description: 'Get doctor answered questions',
	operationId: 'getDoctorAnsweredQuestions',
	parameters: [
		{
			name: 'limit',
			in: 'query',
	...
	responses: {
		'200': {
			description: 'Successfully retrieved doctor answered questions',
			content: {
				'application/json': {
					schema: {
						type: 'object',
						properties: {
							...
							message: {
								type: 'string',
								example: 'Successfully retrieved doctor answered questions',
							},
							data: {
								type: 'array',
								items: {
...
const getDoctorAnsweredQuestion = {
	tags: ['Doctors'],
	description: 'Get doctor answered question by question id',
	operationId: 'getDoctorAnsweredQuestion',
	parameters: [
		{
			name: 'questionId',
			in: 'path',
	...
	responses: {
		'200': {
			description: 'Successfully retrieved doctor answered question',
			content: {
				'application/json': {
					schema: {
						type: 'object',
						properties: {
							...
							message: {
								type: 'string',
								example: 'Successfully retrieved doctor answered question',
							},
							data: {
								type: 'object',
								properties: {
		...
		'401': {
			description: 'User must be a doctor to get user question',
			content: {
				'application/json': {
					schema: {
						type: 'object',
						properties: {
							...
							message: {
								type: 'string',
								example: 'User must be a doctor to get question',
							},
							data: {
								type: 'object',
								properties: {
									...
									msg: {
										type: 'string',
										example: 'User must be a doctor to get user question',
									},
								},
							},
						},
